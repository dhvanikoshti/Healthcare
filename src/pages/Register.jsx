...
const Register = () => {
  ...
  const inputClasses = "w-full px-4 py-3 md:px-5 md:py-4 bg-white border-2 border-gray-200 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#547792] focus:border-[#547792] transition-all duration-300 text-base";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 md:p-8 relative">
      ...
      <div className="relative w-full max-w-4xl animate-fade-in">
        <div className="bg-white rounded-none shadow-2xl p-6 md:p-14">
          <div className="flex items-center justify-center mb-8 md:mb-10">
            <div className="flex items-center gap-3 md:gap-4">
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-xl flex items-center justify-center shadow-lg" style={{ backgroundColor: '#547792' }}>
              ...
              <div className="text-left">
                <h2 className="text-2xl md:text-4xl font-bold text-gray-800">Create Account</h2>
                <p className="text-gray-500 text-sm md:text-base">Join us and start your healthcare journey</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4 md:space-y-6">
            ...
            <div className="pt-4 md:pt-6">
              <button type="submit" disabled={isSubmitting} className="w-full py-3 md:py-4 text-white font-bold text-base md:text-lg rounded-lg shadow-xl transform hover:scale-[1.01] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed" style={{ backgroundColor: '#547792' }}>
            ...
            <div className="relative flex py-4 md:py-6 items-center">
              ...
              <span className="flex-shrink mx-4 md:mx-6 text-gray-400 font-medium">or</span>
              <div className="flex-grow border-t-2 border-gray-200"></div>
            </div>

            <button type="button" className="w-full py-3 md:py-4 bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-semibold text-sm md:text-base rounded-lg flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-lg">
