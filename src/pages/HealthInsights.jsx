    ...
    >
      <div>
            ...
            <div className="bg-slate-100/50 p-1.5 rounded-[1.5rem] border border-slate-200 mb-8 w-full shadow-inner animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="flex gap-1.5">
                ...
                <button
                  ...
                  className={`flex-1 py-3 px-6 rounded-[1.2rem] font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${activeTab === 'diagnosis' ? 'bg-white text-[#263B6A] shadow-md border border-slate-100' : 'text-slate-500 hover:text-slate-700 hover:bg-white/50'}`}
                >
        ...
        {!hasReports && !isLoading && (
          <div className="min-h-[65vh] flex flex-col items-center justify-center text-center animate-in fade-in zoom-in duration-700">
            <div className="w-32 h-32 bg-blue-50 rounded-[2.5rem] flex items-center justify-center mb-10 shadow-xl border border-blue-100/50">
            ...
            <h2 className="text-4xl font-black text-slate-800 uppercase tracking-tight mb-4">Start Your Journey</h2>
            <p className="text-slate-400 max-w-md mx-auto font-medium leading-relaxed mb-12">Upload your first medical report to unlock clinical insights and diagnostic risk assessment.</p>
            <a href="/upload" className="px-10 py-5 bg-slate-800 text-white font-black uppercase tracking-widest text-xs rounded-2xl shadow-2xl hover:scale-105 active:scale-95 transition-all">
              Upload Report
            </a>
          </div>
        )}
