      ...
      <div className="rounded-3xl p-6 lg:p-8 mb-8 text-white  relative overflow-hidden" style={{ backgroundColor: '#263B6A' }}>
        ...
        <div className="relative z-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold mb-2">Welcome, {userName}!</h1>
              ...
              <div className="flex flex-wrap gap-3 mt-5">
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/10">
                  ...
                  <span className="text-sm font-medium">Health Score: <span className="text-cyan-400 font-bold">87/100</span></span>
                </div>
                <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-xl border border-white/10">
                  <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="text-sm font-medium">Last Checkup: <span className="text-green-400 font-bold">{stats.lastCheckup}</span></span>
                </div>
              </div>
            </div>
          </div>
