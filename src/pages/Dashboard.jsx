  ...
  const { trendData, availableYears } = useMemo(() => {
    ...
    allReports.forEach(report => {
      ...
      if (yearStr === selectedYear || selectedYear === 'All') {
        ...
        if (medicalData.length === 0 && report.analysis) {
          const risksRaw = report.analysis.risks || report.analysis.risk_assessment || [];
      ...
      {loading ? (
        <div className="flex items-center justify-center h-[60vh]">
          <div className="relative">
            ...
            <div className="mt-4 text-slate-500 font-medium animate-pulse text-center">Loading Dashboard...</div>
          </div>
        </div>
      ) : (
        <>
