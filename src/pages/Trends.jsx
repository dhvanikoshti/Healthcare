          ...
          <div className="relative">
            ...
            {isDropdownOpen && (
              <>
                ...
                <div className="absolute top-full right-0 sm:right-0 z-[120] mt-1 sm:mt-2 w-48 xs:w-56 sm:w-80 overflow-hidden bg-white rounded-xl sm:rounded-2xl border border-slate-100 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] animate-in fade-in zoom-in duration-200 origin-top-right">
                  <div className="max-h-[180px] sm:max-h-[320px] overflow-y-auto custom-scrollbar py-0.5 sm:py-2">
