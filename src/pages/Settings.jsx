  ...
  const handleLogoutSession = async (sessionId) => {
    try {
      ...
      if (user) {
        ...
        showToastMsg('Device logged out successfully');
      }
    } catch (error) {
      console.error('Error logging out device:', error);
      showToastMsg('Failed to logout device', 'error');
    }
  };
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2 custom-scrollbar no-scrollbar">
          {tabs.map((tab) => (
            <button
              ...
              className={`flex items-center gap-2 px-5 py-3 rounded-xl font-medium transition-all ${activeTab === tab.id ? 'bg-gray-800 text-white shadow-lg' : 'bg-white text-gray-600 hover:bg-white border border-gray-200'}`}
            >
            ...
            <div className="px-6 md:px-10 pt-6 md:pt-10 pb-10 relative">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 mb-8 pb-8 border-b border-gray-100">
                ...
                <div className="text-center md:text-left mt-2 md:mt-0 flex-1">
                  <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight">{userData.name || 'User Name'}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div className="bg-white p-1">
                  ...
                  {isEditing ? (
                    <input type="text" name="name" value={userData.name} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:bg-white transition-all text-gray-800" />
                  ) : (
                    <p className="text-gray-900 font-medium px-4 py-3 bg-white rounded-xl border border-gray-100">{userData.name || 'Not set'}</p>
                  )}
                </div>
                ...
                <div className="bg-white p-1">
                  ...
                  {isEditing ? (
                    <input type="email" name="email" value={userData.email} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:bg-white transition-all text-gray-800" />
                  ) : (
                    <p className="text-gray-900 font-medium px-4 py-3 bg-white rounded-xl border border-gray-100">{userData.email || 'Not set'}</p>
                  )}
                </div>
                ...
                <div className="bg-white p-1">
                  ...
                  {isEditing ? (
                    <input type="tel" name="contactNumber" value={userData.contactNumber} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:bg-white transition-all text-gray-800" />
                  ) : (
                    <p className="text-gray-900 font-medium px-4 py-3 bg-white rounded-xl border border-gray-100">{userData.contactNumber || 'Not set'}</p>
                  )}
                </div>
                ...
                <div className="bg-white p-1">
                  ...
                  {isEditing ? (
                    <input type="date" name="dob" value={userData.dob} onChange={handleChange} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:bg-white transition-all text-gray-800" />
                  ) : (
                    <p className="text-gray-900 font-medium px-4 py-3 bg-white rounded-xl border border-gray-100">{userData.dob || 'Not set'}</p>
                  )}
                </div>
